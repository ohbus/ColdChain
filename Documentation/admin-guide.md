...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A01.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A02.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A03.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A04.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A05.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A06.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A07.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A08.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A09.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A010.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A011.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A012.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A013.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A014.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A015.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A016.png)

2.	Click on the Vulnerability Assessment

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A017.png)

3.	To start using vulnerability assessment, you need to configure a storage account where scan results are saved. 

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A018.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A019.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A020.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A021.png)

Analyze the results and resolve issues

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A022.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A023.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A024.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A025.png)

3.	To begin classifying your data, click on the **Classification tab** at the top of the window.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A026.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A027.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A028.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A029.png)

3.	Fill all the details and click Save.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A030.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A031.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A032.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A033.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A034.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A035.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/A036.png)
...
1.	Go to **Azure Portal -> Resource Group -> Web App**
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a1.png)

2.	Here click on the **Application Insight**

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a2.png)

3.	Click on **Turn on site extension** for **Web App** and **Function App**

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a3.png)

4.	Select following in the **application insight** and click **Apply** button it will navigating to the popup window. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a4.png)

5.	Click **Yes**

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a5.png)

6.	Go to **Resource group** and click on **application insight**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a6.png)
...
8.	Click **Performance** on the left side of the page as shown below. 
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a7.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a8.png)

9.	Click on **Dropdown list** and select **Request time** in the following screenshot.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a9.png)

10.	After click on that **Request time**, it will open a new tab with some default queries & chart for the same. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a10.png)

11.	Click on **Request** it will open a new tab with request and response operations. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a11.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a12.png)

12.	Click **Chart** icon it should be display default queries & chart. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a13.png)

13.	Click on **Failure** on the left side of the page as shown below.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a14.png)

14.	Click on **View in Analytics** and select any of the analytics. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a15.png)

15.	After click on **Request Count**, it will open a new tab with some default queries & chart

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a16.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a17.png)
...
18.	Here we can see the graph after specifying our need. 
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a18.png)
...
20.	After click on **application map** you can see the screen like below. 
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a19.png)

21.	When you click on **ccfunapp07gm** it will open popup window in right side and click on **Investigate Performance** button. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a20.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a21.png)
...
22.	To check the **logs**, click on the chart of which you want to see the logs then you will get the logs of each request as shown in below figure.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a22.png)
...
23. Click on **Live Metric Stream** to view the incoming requests, outgoing requests, overall health and servers of web application and function app.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a23.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a24.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a25.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a26.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a27.png)
...
1.	Open **Azure Portal -> Resource Group** -> Click the **OMS Workspace** in resource group to view OMS Overview Section. 
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a28.png)
...
3.	Select your **Subscription** and **Resource Group** name from the dropdown list. 
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a29.png)
...
5.	Copy **Resource group name** and past it in the **search box** and we write the **Kusto query language** and click **Run** button, it should show the Resource group Telemetry data.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a30.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a31.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a32.png)

6.	Here you can check the **resource group** information is displayed below the page as shown in the following figure.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a33.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a34.png)
...
8.	Here you can see the **IoT hub resource Telemetry information** is displayed below the page as show in the following figure.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a35.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a36.png)

9.	Here you can see the **IoT hub resource information** is displayed below the page as show in the following figure.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a37.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a38.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a39.png)
...
11.	Here you can see the **Cosmos DB resource Telemetry information** is displayed below the page as show in the following figure.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a40.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a41.png)

12.	Here you can see the **Cosmos DB resource information** is displayed below the page as show in the following figure.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a42.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a43.png)
...
14.	Here you can see the **SQL DB resource Telemetry information** is displayed below the page as show in the following figure.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a44.png)

15.	Here you can see the **SQL DB resource information** is displayed below the page as show in the following figure.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a45.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a46.png)
...
2.	Click on **Stop button** to stop the web application.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a48.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a49.png)

3.	Go to **resource group** and click on **traffic manager** then you can see the primary web app is stopped.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a50.png)

4.	Copy the **traffic manager URL** and check the use case flow.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a51.png)

5.	Go back to the **resource group** and click on **Function App**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a52.PNG)

6.	In the overview page click on **Stop** the **Function App**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a53.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a54.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a55.png)

7.	Go to **Resource Group** -> Click on **Stream Analytics**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a56.PNG)

8.	Click on **Stop the Stream Analytics**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a57.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a58.png)
...
1.	Go to **Resource Group** -> Click on **Traffic Manager** from the below resources
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a59.PNG)

2.	Copy the **DNS name** and open it in browser.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a60.png)

3.	Now you can see the landing page of **Web Application**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a61.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr19.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr20.png)

6.	Choose the **default values** and click on **OK**

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr21.png)

7.	Then “**Failover**” starts as shown below. It will take some time to perform the **Failover**.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr22.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr23.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr24.png)

10.	You see a **new VM** is created in the **resource group** as **source VM** as shown below.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr25.png)

11.	Repeat the Failover step for all the VMs, you can see all VMs in the “-asr” resource group as shown below.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr26.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr27.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr28.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr29.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr30.png)

17.	Click on **Inbound NAT rules**, then click on **Natssh0**

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr31.png)

18.	Then select the **Target virtual machine** and **Network IP configuration** then click on **Save**.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr32.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr34.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr35.png)

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr36.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr33.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr37.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr38.png)

26.	Click on the **Endpoints** and the endpoint.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr39.png)

27.	It opens the configured the endpoint, click on **Delete** to delete the previous endpoint.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr40.png)

28.	 Click on **Endpoints** and click on **Add**

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr41.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr42.png)

30.	 You can find the newly added endpoint as shown below.

![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/asr43.png)
...
1. Go to **Resource Group** -> Click on **IoT Hub**.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a62.PNG)

2. Go to **Manual Failover** in the left side menu.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a63.png)

3. Click on **Initiate Failover**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a64.png)

4. It will open a new window in right side menu, enter **Alias name** and click **Ok** button.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a65.png)
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a66.png)

5. Here you can see the manual failover from **East US 2 to Central US** is in progress.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a67.png)
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a68.png)

6. Here you can see the failover IoT Hub to the **Secondary Location Central US**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a69.png)
...
1. Go to **Resource Group** -> Click on **Cosmos DB** resource.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a70.png)

2. Click on **Replicate data globally** in the left side menu.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a71.png)

3. Click on **Manual Failover**

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a72.png)

4. It will open a new window and select the **read reasons**, click **check box** and click on **Ok** button.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a73.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a74.png)

5. After manual failover is done, you can see the write region as **Central US** and read regions as **East US 2**

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a75.png)
...
1. Go to **Resource Group** -> Click on **SQL Server** resource.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a76.png)

2. Click on **Failover group** in the left side menu and click on the **failover group**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a77.png)


3. Click on **Failover** to failover group to failover.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a78.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a79.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a80.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a81.png)

4. Here you can see the secondary resource as **primary role**.    

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a82.png)
...
1.	Go to the **GitHub** and select **re-deploy.json** file from **master branch**. Copy the re-deploy.json template.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a83.png)
...
5.    **Replace / paste** the template and click **Save** button.
   ...
   ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a87.png)
    
  
  ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a88.png)
    
   ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a89.png)
    
   ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a90.png)
    
   ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a91.png)
...
2.	Copy the **Traffic Manager URL** and open it in browser.  
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/admin92.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a93.png)
...
After successful validation by the **Azure AD**, based on the user role the web app will redirect you to **Admin Page** 
  ...
  ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/view.png)

4.	Click on **document icon** in the **shipment tab**, it will expand a section where you can upload your documents. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a94.png)

5.	Click on **Choose Files Button** which will open a window for you to select the file.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a95.png)
...
7.	The next step is to upload document information to the **Blockchain**. For this, select the Document Type from the drop-down list.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a96.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a97.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a98.png)
...
8.	Click on **Upload to Blockchain** button which will upload the document information in the **Blockchain**. After successful upload, you will see a response as below.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a99.png)
...
9.	When you click the **View Document Button**, a section gets expanded below the ribbon where you will be able to see a table which contains a list of documents against the respective shipment. The expanded section is highlighted in the below image.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a100.png)
...
10.	When you click on view icon button you will be able to view the document in the new tab or it will get downloaded if the file extension is other than **.pdf**
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a101.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a102.png)

11.	To check if the status of the shipment is updated or not, click on **shipment ID** of the ribbon as shown below.  

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a103.png)
...
13.	To check whether the record of shipment status is recorded in **Blockchain** or not, you can simply check the **Blockchain Transactions** sections under the **Shipping Details** sections where all the transaction made to the **Blockchain** are shown in chronological order.  
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a104.png)
    

14.	Click on the **transaction hash** which will show the **transaction details** in a modal as below.  

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a105.png)
...
15.	The **Tracker Tab** will be rendered which will show the last known location of the shipment. The view of this tab is shown above. When you click on the marker, a pop-up will be display next to the marker that will show **shipment details** and incidents.  
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a106.png)
...
16.	The **Status Tab** will show a list of objects along with their **Object ID, Beacon ID**, the object it is associated with, **Temperature, Humidity, Shock and Vibration Alerts, and count of incidents**.  
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a107.png)
...
17.	The **Devices Tab** will consist of a list of association of beacons and objects with **Gateways**. The connectivity status of the devices will also be shown in this list.  
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a108.png)

18.	The **Incidents Tab** consists of a list of all the alerts that has occurred over the course of monitoring the shipment. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a109.png)
...
19.	This tab shows all the alerts that are stored in **Blockchain**. All the information regarding the alert will be shown in this tab along with **Alert Starting Time and Alert Ending Time**.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a110.png)

20.	Here you can see the whatever you added Beacons and Sensor data. 

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a111.png)
...
23.	Click on **IoT devices** in the left side menu.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a113.png)

24.	Click on **Device ID**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a114.png)

25.	Click on **Device twin**, here you can see the Status of the device.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a115.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a116.png)

26.	And check the **Message count** is increasing or not.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a117.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a118.png)

27.	Go back to the **Resource Group** -> Click on **Cosmos DB**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a119.png)


28.	Click on **Data Explorer** in the left side menu.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a120.png)

29.	Here you can check the latest transaction message/document.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a121.png)
...
31.	Here you can see the increasing **Input Events and Output Events**.
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a123.png)
    
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a124.png)


32.	Go back to **Resource Group** -> Click on **SQL database**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a125.png)

33.	Click on **Query editor** in the left side menu.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a126.png)
...
![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a127.png)

35.	Here you can see the latest stored record.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a128.png)
...
2.	Copy the **DNS name** and open it in browser. 
    ...
    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a130.png)

3.	Now you can see the landing page of **Web Application**.

    ![alt text](https://github.com/SecureColdChain/Wipro-Ltd-ColdChain/blob/master/Documentation/images/a131.png)
